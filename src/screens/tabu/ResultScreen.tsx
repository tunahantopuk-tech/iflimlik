...
type ResultScreenNavigationProp = StackNavigationProp<TabuStackParamList, 'TabuResult'>;
type ResultScreenRouteProp = RouteProp<TabuStackParamList, 'TabuResult'>;
...
export default function TabuResultScreen({ navigation, route }: ResultScreenProps) {
  const { 
    team1Name, 
    team2Name, 
    team1Score, 
  ...
  const handlePlayAgain = () => {
    navigation?.navigate?.('TabuSetup');
  };

  const handleGoHome = async () => {
    await lockActivity('tabu');
      ...
      <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.animationContainer}>
            {winner !== 'Berabere' ? (
              <>
                <Ionicons name="trophy" size={120} color="#E91E63" />
              ...
              <>
                <Ionicons name="people" size={120} color="#E91E63" />
            ...
            <View style={styles.teamsRow}>
              ...
              <View style={[styles.teamRoster, isTeam1Winner && styles.teamRosterWinner]}>
                <View style={styles.teamHeader}>
                  ...
                  {isTeam1Winner && <Ionicons name="trophy" size={20} color="#E91E63" />}
                </View>
                <View style={styles.playersList}>
                  {team1PlayersArray?.map?.((player: string, index: number) => (
                    <View key={index} style={styles.playerItem}>
                      <View style={styles.playerInfo}>
                        <Ionicons name="person" size={14} color="#E91E63" />
              ...
              <View style={[styles.teamRoster, isTeam2Winner && styles.teamRosterWinner]}>
                <View style={styles.teamHeader}>
                  ...
                  {isTeam2Winner && <Ionicons name="trophy" size={20} color="#E91E63" />}
                </View>
                <View style={styles.playersList}>
          ...
          <View style={styles.buttonsContainer}>
            <TouchableOpacity style={styles.button} onPress={handlePlayAgain}>
              ...
              >
                ...
                <Text style={[styles.buttonText, { color: '#fff' }]}>Tekrar Oyna</Text>
              </LinearGradient>
            </TouchableOpacity>
